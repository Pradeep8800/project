...
function AddOrder(props) {
    ...
    return ( <
            ...
            style = {
                { height: "25px", width: "500px", marginLeft: "125px" }
            } >
            <
            ...
            select > <
            /div> <
            InitialForm onSubmit = { initialSubmitHandler }
            category = { category }
            cart = { cartHandler }
            />

            <
            TempOrder tempOrder = { data }
            cart = { cart }
            /> <
            ...
            /button> < /
            form > <
            Orders orders = { storeOrders }
            editOrder = { editOrderHandler }
            dispatchOrder = { dispatchOrder }
            /> {
            editOrder && ( <
                EditOrder editOrderId = { editOrderId.current }
